            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="py-4 px-6 text-right">
                        @can('update', $coach)
                            <a href="{{ route('users.role.edit', $coach->id) }}" class="mx-1 font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                        @endcan

                        @can('delete', $coach)
                            <form action="{{ route('users.role.destroy', $coach->id) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
